...
> - «06 — Preparación del release 1.0.0 e instalador» / «06 — Release 1.0.0 preparation and installer» (revisión 1: convención `v1.0.0` en UI vs `1.0.0` en Git tag, bundle autónomo Node.js, instalador local `install.sh`, directorio `~/.forge614/`, sumas SHA-256 y hoja de ruta en 3 niveles).
>
