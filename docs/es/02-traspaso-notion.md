...
2026-09-18 · Etapas 01 y 02 · Revisión 9 · [English](../en/02-notion-handoff.md) · [Índice](../../README.md)

**Estado: Documentación local completa y verificada (124 pruebas pasando en 32 archivos). Sincronización en Notion de las revisiones 5, 6, 7, 8 y 9 pendiente por renovación de credenciales OAuth del MCP de Notion.**
...
- [00-instalacion-y-prueba-local-release.md](00-instalacion-y-prueba-local-release.md): guía paso a paso desde cero para probar la instalación local en macOS (revisión 2: clarificación del tag 1.0.0 en origin frente a la publicación web del release privado de GitHub).
- [00-installation-and-local-release-test.md](../en/00-installation-and-local-release-test.md): step-by-step beginner guide for macOS local installation testing (revision 2: clarification of origin tag 1.0.0 vs private GitHub web release publication).
...
- [02-traspaso-notion.md](02-traspaso-notion.md) y [02-notion-handoff.md](../en/02-notion-handoff.md): instrucciones y registro de sincronización ES/EN (revisión 9).
...
- [06-preparacion-release-1.0.0-instalador.md](06-preparacion-release-1.0.0-instalador.md): preparación del release local 1.0.0, convención de versiones (etiqueta UI `v1.0.0`, tag Git `1.0.0`, release `Forge614 Shell v1.0.0`), generador de bundle autónomo (`scripts/release-bundle.mjs`), instalador de archivos (`scripts/install.sh`), layout versionado en `~/.forge614/`, flujo web para mantenedores de creación de GitHub Release privado con 3 assets adjuntos (`.tar.gz`, `.sha256`, `install.sh`), checklist posterior a publicación, sumas SHA-256 y hoja de ruta en 3 niveles (revisión 2 con 124 tests).
- [06-release-1.0.0-bundle-installer.md](../en/06-release-1.0.0-bundle-installer.md): release 1.0.0 local preparation, versioning conventions (UI label `v1.0.0`, Git tag `1.0.0`, release `Forge614 Shell v1.0.0`), standalone bundle builder (`scripts/release-bundle.mjs`), archive installer (`scripts/install.sh`), versioned layout under `~/.forge614/`, maintainer web workflow for creating a private GitHub Release with 3 attached assets (`.tar.gz`, `.sha256`, `install.sh`), post-publishing checklist, SHA-256 checksums, and roadmap in English (revision 2 with 124 tests).
...
> - «00 — Instalación y prueba local del release» / «00 — Installation and local release test» (revisión 2: guía paso a paso para principiantes en macOS, empaquetado, prueba aislada en `~/.forge614-test/`, verificación, solución de problemas y relación con el release web privado).
> - «01 — Alcance y decisiones» / «01 — Scope and decisions» (revisión 2).
> - «02 — Traspaso a Notion» / «02 — Notion handoff» (revisión 9).
...
> - «06 — Preparación del release 1.0.0 e instalador» / «06 — Release 1.0.0 preparation and installer» (revisión 2: convención `v1.0.0` en UI vs `1.0.0` en Git tag, bundle autónomo Node.js, instalador local `install.sh`, directorio `~/.forge614/`, flujo web para mantenedores para crear release privado en GitHub con notas y 3 assets adjuntos, checklist post-publicación, sumas SHA-256 y hoja de ruta en 3 niveles).
>
...
| Revisión publicada en Notion | 4 (Páginas 01 a 04 sincronizadas); Páginas 00, 05, 06 y Rev 5-9 pendientes de reconexión OAuth |
