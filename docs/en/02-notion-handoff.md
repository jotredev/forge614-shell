...
2026-09-18 · Stages 01 and 02 · Revision 9 · [Español](../es/02-traspaso-notion.md) · [Index](../../README.md)

**Status: Local documentation complete and verified (124 tests passing across 32 files). Notion synchronization for revisions 5, 6, 7, 8, and 9 pending Notion MCP OAuth credential renewal.**
...
- [00-instalacion-y-prueba-local-release.md](../es/00-instalacion-y-prueba-local-release.md): step-by-step beginner guide for macOS local installation testing in Spanish (revision 2: clarification of origin tag 1.0.0 vs private GitHub web release publication).
- [00-installation-and-local-release-test.md](00-installation-and-local-release-test.md): step-by-step beginner guide for macOS local installation testing in English (revision 2: clarification of origin tag 1.0.0 vs private GitHub web release publication).
...
- [02-traspaso-notion.md](../es/02-traspaso-notion.md) and [02-notion-handoff.md](02-notion-handoff.md): sync instructions and record in ES/EN (revision 9).
...
> - "00 — Instalación y prueba local del release" / "00 — Installation and local release test" (revision 2: step-by-step beginner guide on macOS, bundling, safe isolated test under `~/.forge614-test/`, verification, troubleshooting, and relation to the private web release).
> - "01 — Alcance y decisiones" / "01 — Scope and decisions" (revision 2).
> - "02 — Traspaso a Notion" / "02 — Notion handoff" (revision 9).
...
> - "06 — Preparación del release 1.0.0 e instalador" / "06 — Release 1.0.0 preparation and installer" (revision 2: `v1.0.0` UI label vs `1.0.0` Git tag, standalone Node.js bundle, local `install.sh` installer, `~/.forge614/` layout, maintainer web workflow for creating private GitHub Release with notes and 3 attached assets, post-publishing checklist, SHA-256 digests, and three-tier distribution roadmap).
>
...
| Revision published in Notion | 4 (Pages 01 to 04 synced); Pages 00, 05, 06 and Rev 5-9 pending OAuth renewal |
