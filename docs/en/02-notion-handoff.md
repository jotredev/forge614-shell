...
2026-09-18 · Stages 01 and 02 · Revision 10 · [Español](../es/02-traspaso-notion.md) · [Index](../../README.md)

**Status: Local documentation complete and verified (124 tests passing across 32 files, 567 assertions). Notion synchronization for revisions 5, 6, 7, 8, 9, and 10 pending Notion MCP OAuth credential renewal.**
...
- [00-instalacion-y-prueba-local-release.md](../es/00-instalacion-y-prueba-local-release.md): step-by-step beginner guide for macOS local installation testing in Spanish (revision 3: automatic PATH configuration with zero manual commands, collaborator 3-asset download workflow from GitHub Releases, and immutable patch policy for 1.0.1).
- [00-installation-and-local-release-test.md](00-installation-and-local-release-test.md): step-by-step beginner guide for macOS local installation testing in English (revision 3: automatic PATH configuration with zero manual commands, collaborator 3-asset download workflow from GitHub Releases, and immutable patch policy for 1.0.1).
...
- [02-traspaso-notion.md](../es/02-traspaso-notion.md) and [02-notion-handoff.md](02-notion-handoff.md): sync instructions and record in ES/EN (revision 10).
...
> - "00 — Instalación y prueba local del release" / "00 — Installation and local release test" (revision 3: step-by-step beginner guide on macOS, bundling, installation with automatic PATH injection without manual commands, asset download from GitHub Releases for collaborators, and immutable patch policy for 1.0.1).
> - "01 — Alcance y decisiones" / "01 — Scope and decisions" (revision 2).
> - "02 — Traspaso a Notion" / "02 — Notion handoff" (revision 10).
...
> - "06 — Preparación del release 1.0.0 e instalador" / "06 — Release 1.0.0 preparation and installer" (revision 3: published private release `Forge614 Shell v1.0.0`, `v1.0.0` UI label vs `1.0.0` Git tag, standalone Node.js bundle, installer with automatic PATH injection into shell profiles, collaborator downloads with SHA-256 verification, immutability of published tags, and 6-step patch release workflow for 1.0.1).
>
...
| Revision published in Notion | 4 (Pages 01 to 04 synced); Pages 00, 05, 06 and Rev 5-10 pending OAuth renewal |
